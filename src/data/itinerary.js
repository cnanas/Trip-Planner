...
export const HOTELS_B = [
  ...
  },
  {
    ...
    alternatives: [
      {
        id: "hotel-b4-alt1",
        name: "Motel 6 Missoula",
        address: "3035 Expo Pkwy, Missoula, MT 59808",
        lat: 46.8899,
        lng: -114.0215,
        rating: 4.0,
        phone: "+14065496665",
        petNotes: "FREE pet fee — 2 dogs allowed.",
        priceRange: "$55–70/night",
      },
      {
        id: "hotel-b4-alt2",
        name: "La Quinta by Wyndham Missoula",
        address: "5059 N Reserve St, Missoula, MT 59808",
        lat: 46.9011,
        lng: -114.1008,
        rating: 4.2,
        phone: "+14065499000",
        petNotes: "Pets free, $75 max per stay. Grab-and-go breakfast.",
        priceRange: "$84–100/night",
      },
    ],
  },
]
